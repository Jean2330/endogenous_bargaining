...
\textcolor{olive}{Nota: esta es la versión estática (para un $W_t$ dado) de la Lema C.1 de la tesina, con una prueba corregida de manera independiente, no una copia; ver NOTES.md para el detalle completo.}
