# tests/test_model.py
# Sanity checks. Run with: python -m pytest tests/ -v
#
# Three classes of checks:
#   (i)   Closed-form formulas match direct calculation
#   (ii)  Model properties that must hold analytically
#   (iii) Calibration: feasible set is non-empty in the binding regime
